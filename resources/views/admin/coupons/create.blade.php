                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <form method="post" action="\admins\coupons">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" placeholder="عنوان تخفیف">
                            </div>
                            <div class="form-group">
                                <label for="code">کد تخفیف</label>
                                <input type="text" name="code" class="form-control" placeholder="کد تخفیف"></input>
                            </div>
                            <div class="form-group">
                                <label for="price">مقدار تخفیف</label>
                                <input type="number" name="price" class="form-control" placeholder="مقدار تخفیف"></input>
                            </div>
                            <div class="form-group required">
                                <label for="input-gender" class="col-sm-2 control-label">وضعیت</label>
                                <input type="radio" name="status" value="1"><span>منتشر شده</span></br>

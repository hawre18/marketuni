<template>
    <div :class="['vue-star-rating', {'vue-star-rating-ltr':ltr}, {'vue-star-rating-inline': inline}]">
        <div @mouseleave="resetRating" class="vue-star-rating">
            ...
            <span v-if="showRating" :class="['vue-star-rating-rating-text', textClass]" name="rating"> {{formattedRating}}</span>
        </div>
    </div>
</template>
...
.vue-star-rating-ltr .vue-star-rating-rating-text {
    margin-right: 10px;
    direction: ltr;
}
</style>
